# sanskrit-desktop-dict

FIXME: my new application.

## Installation

Download from https://github.com/licht1stein/sanskrit-desktop-dict
...
Run the project directly, via `:main-opts` (`-m licht1stein.sanskrit-desktop-dict`):
